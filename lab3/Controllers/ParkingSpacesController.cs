...
namespace lab3.Controllers
{
    public class ParkingSpacesController : Controller
    {
        ...
        public ParkingSpacesController(lab3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Number,Parked")] ParkingSpace parkingSpace)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Number,Parked")] ParkingSpace parkingSpace)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'lab3Context.ParkingSpace'  is null.");
            }
            var parkingSpace = await _context.ParkingSpace.FindAsync(id);
            if (parkingSpace != null)
            {
